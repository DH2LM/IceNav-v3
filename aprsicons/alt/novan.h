...
#ifndef LV_ATTRIBUTE_IMG_NOVAN
#define LV_ATTRIBUTE_IMG_NOVAN
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_NOVAN uint8_t novan_map[] = {
