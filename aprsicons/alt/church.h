...
#ifndef LV_ATTRIBUTE_IMG_CHURCH
#define LV_ATTRIBUTE_IMG_CHURCH
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CHURCH uint8_t church_map[] = {
