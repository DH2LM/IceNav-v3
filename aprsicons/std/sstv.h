...
#ifndef LV_ATTRIBUTE_IMG_SSTV
#define LV_ATTRIBUTE_IMG_SSTV
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_SSTV uint8_t sstv_map[] = {
