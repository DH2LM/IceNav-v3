...
#ifndef LV_ATTRIBUTE_IMG_LAPTOP
#define LV_ATTRIBUTE_IMG_LAPTOP
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_LAPTOP uint8_t laptop_map[] = {
