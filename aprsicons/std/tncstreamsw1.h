...
#ifndef LV_ATTRIBUTE_IMG_TNCSTREAMSW1
#define LV_ATTRIBUTE_IMG_TNCSTREAMSW1
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_TNCSTREAMSW1 uint8_t tncstreamsw1_map[] = {
...
const lv_img_dsc_t tncstreamsw1 = {
