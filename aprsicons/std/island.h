...
#ifndef LV_ATTRIBUTE_IMG_ISLAND
#define LV_ATTRIBUTE_IMG_ISLAND
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_ISLAND uint8_t island_map[] = {
